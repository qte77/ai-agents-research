...
| [`docs/configuration/`](docs/configuration/) | Model/provider configuration, fast mode, hooks system, bash mode |
| [`docs/packaging-enterprise/`](docs/packaging-enterprise/) | Plugin packaging, cowork/enterprise plugins, Chrome extension, web scraping plugins |
