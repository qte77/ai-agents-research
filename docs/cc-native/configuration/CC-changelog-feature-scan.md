...
purpose: Identify actionable CC features from recent releases (v2.1.0–2.1.201) not yet covered by existing analysis docs. Applicable to any project using Claude Code.
created: 2026-03-07
updated: 2026-04-06
