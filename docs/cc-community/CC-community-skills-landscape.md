...
- [agents-cli-analysis.md](../non-cc/frameworks/agents-cli-analysis.md) — Google agents-cli installs as a CC skill-pack (`npx skills add`) but is cross-agent; deeper analysis lives in non-cc
