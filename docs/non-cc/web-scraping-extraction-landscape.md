...
| [Lightpanda](https://lightpanda.io) | AGPL-3.0 | None built-in (not a stealth tool) | Built from scratch in Zig — not a Chromium/WebKit fork; CDP-compatible drop-in for Puppeteer/Playwright |
