...
|-------|---------|-------------|
| [FEATURE] Add Traditional Chinese (繁體中文 / zh-TW) localizatio | GitHub Issues (enhancement) | ## Feature Request  ### Summary  Please add *_Traditional Chinese (繁體中文, zh-TW)_ |
| [Feature Request] Add Spanish language support for microphon | GitHub Issues (enhancement) | **Bug Description** Sería bueno que la transcripsión desde el microfo, que pueda |
| [Feature Request] Add internationalization (i18n) support fo | GitHub Issues (enhancement) | **Bug Description** A interface do CLI (menus, prompts interativos, atalhos) pod |
| [BUG] Claude Code is not local inference friendly | GitHub Issues (enhancement) | ### Preflight Checklist  - [x] I have searched [existing issues](<https://github>. |
| [BUG]  AskUserQuestion tool limited to 4 options is too rest | GitHub Issues (enhancement) | ### Preflight Checklist  - [x] I have searched [existing issues](<https://github>. |
| türkçe kullanım desteği | GitHub Issues (enhancement) | ### Preflight Checklist  - [x] I have searched [existing requests](<https://githu> |
...
| [FEATURE] Support riscv64 (linux/riscv64) architecture | GitHub Issues (enhancement) | ### Preflight Checklist  - [x] I have searched [existing requests](<https://githu> |
| [FEATURE] WriteTemp() tool | GitHub Issues (enhancement) | ### Preflight Checklist  - [x] I have searched [existing requests](<https://githu> |
| [FEATURE] Add memory-compaction-proof ~/.claude/INVARIANT.md | GitHub Issues (enhancement) | ### Preflight Checklist  - [x] I have searched [existing requests](<https://githu> |
